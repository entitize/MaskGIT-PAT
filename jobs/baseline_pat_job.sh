...
#SBATCH -J "grayscale_pat_job_torchvision"   # job name
...
python training_vqgan.py \
    --dataset-path /groups/mlprojects/pat/pat_signals/original_signals \
    --batch-size 4 \
    --experiment-name original_pat_grayscale_torchvision \
    --save-img-rate 1000 \
    --image-channels 1
